...
@ApiModel(value = "管理后台 - 盘点记录表子表-明细 Excel 导出 Request VO", description = "参数和 StockInventoryRecordDetailPageReqVO 是一致的")
@Data
public class StockInventoryRecordDetailExportReqVO {
