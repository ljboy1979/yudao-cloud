...
public class PurchaseDeliverServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetDeliverPage() {
       ...
       // 测试 purchaseId 不匹配
       deliverMapper.insert(cloneIgnoreId(dbDeliver, o -> o.setPurchaseId(null)));
       // 测试 purchaseNumber 不匹配
       deliverMapper.insert(cloneIgnoreId(dbDeliver, o -> o.setPurchaseNumber(null)));
       // 测试 batchCode 不匹配
       deliverMapper.insert(cloneIgnoreId(dbDeliver, o -> o.setBatchCode(null)));
