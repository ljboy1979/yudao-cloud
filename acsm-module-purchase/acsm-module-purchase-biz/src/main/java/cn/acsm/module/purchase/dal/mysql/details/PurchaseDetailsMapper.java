...
public interface PurchaseDetailsMapper extends BaseMapperX<PurchaseDetailsDO> {
    ...
    default PageResult<PurchaseDetailsDO> selectPage(PurchaseDetailsPageReqVO reqVO) {
        return selectPage(reqVO, new LambdaQueryWrapperX<PurchaseDetailsDO>()
                .eqIfPresent(PurchaseDetailsDO::getPurchaseId, reqVO.getPurchaseId())
                .eqIfPresent(PurchaseDetailsDO::getPurchaseNumber, reqVO.getPurchaseNumber())
                ...
                .eqIfPresent(PurchaseDetailsDO::getUnit, reqVO.getUnit())
                .eqIfPresent(PurchaseDetailsDO::getPackagingType, reqVO.getPackagingType())
                .eqIfPresent(PurchaseDetailsDO::getBuyNumber, reqVO.getBuyNumber())
                .eqIfPresent(PurchaseDetailsDO::getFrequency, reqVO.getFrequency())
                .eqIfPresent(PurchaseDetailsDO::getPrice, reqVO.getPrice())
                .eqIfPresent(PurchaseDetailsDO::getDiscount, reqVO.getDiscount())
                .eqIfPresent(PurchaseDetailsDO::getTotal, reqVO.getTotal())
                .eqIfPresent(PurchaseDetailsDO::getStandardId, reqVO.getStandardId())
