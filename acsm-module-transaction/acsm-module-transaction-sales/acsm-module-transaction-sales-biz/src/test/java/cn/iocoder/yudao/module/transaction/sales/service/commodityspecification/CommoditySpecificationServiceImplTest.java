...
public class CommoditySpecificationServiceImplTest extends BaseDbUnitTest {
    ...
    public void testUpdateCommoditySpecification_notExists() {
        ...
        // 调用, 并断言异常
        assertServiceException(() -> commoditySpecificationService.updateCommoditySpecification(reqVO), COMMODITY_SPECIFICATION_NOT_EXISTS);
    }
    ...
    public void testDeleteCommoditySpecification_notExists() {
        ...
        // 调用, 并断言异常
        assertServiceException(() -> commoditySpecificationService.deleteCommoditySpecification(id), COMMODITY_SPECIFICATION_NOT_EXISTS);
    }
