package cn.iocoder.yudao.module.transaction.sales.service.commodity;
...
import cn.iocoder.yudao.module.transaction.sales.dal.mysql.commodity.CommodityMapper;
...
import static cn.iocoder.yudao.module.transaction.sales.enums.ErrorCodeConstants.COMMODITY_NOT_EXISTS;
...
public class CommodityServiceImplTest extends BaseDbUnitTest {
    ...
    public void testUpdateCommodity_notExists() {
        ...
        // 调用, 并断言异常
        assertServiceException(() -> commodityService.updateCommodity(reqVO), COMMODITY_NOT_EXISTS);
    }
