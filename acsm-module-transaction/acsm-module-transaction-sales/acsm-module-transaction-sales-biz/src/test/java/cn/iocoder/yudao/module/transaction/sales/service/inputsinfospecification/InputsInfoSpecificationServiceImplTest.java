...
public class InputsInfoSpecificationServiceImplTest extends BaseDbUnitTest {
    ...
    public void testUpdateInputsInfoSpecification_notExists() {
        ...
        // 调用, 并断言异常
        assertServiceException(() -> inputsInfoSpecificationService.updateInputsInfoSpecification(reqVO), INPUTS_INFO_SPECIFICATION_NOT_EXISTS);
    }
    ...
    public void testDeleteInputsInfoSpecification_notExists() {
        ...
        // 调用, 并断言异常
        assertServiceException(() -> inputsInfoSpecificationService.deleteInputsInfoSpecification(id), INPUTS_INFO_SPECIFICATION_NOT_EXISTS);
    }
