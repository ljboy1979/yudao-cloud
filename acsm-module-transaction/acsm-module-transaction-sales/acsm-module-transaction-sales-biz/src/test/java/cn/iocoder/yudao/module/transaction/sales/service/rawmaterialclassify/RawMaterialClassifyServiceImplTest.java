...
public class RawMaterialClassifyServiceImplTest extends BaseDbUnitTest {
    ...
    public void testUpdateRawMaterialClassify_notExists() {
        ...
        // 调用, 并断言异常
        assertServiceException(() -> rawMaterialClassifyService.updateRawMaterialClassify(reqVO), RAW_MATERIAL_CLASSIFY_NOT_EXISTS);
    }
    ...
    public void testDeleteRawMaterialClassify_notExists() {
        ...
        // 调用, 并断言异常
        assertServiceException(() -> rawMaterialClassifyService.deleteRawMaterialClassify(id), RAW_MATERIAL_CLASSIFY_NOT_EXISTS);
    }
