...
public class DishesCategoryServiceImplTest extends BaseDbUnitTest {
    ...
    public void testUpdateDishesCategory_notExists() {
        ...
        // 调用, 并断言异常
        assertServiceException(() -> dishesCategoryService.updateDishesCategory(reqVO), DISHES_CATEGORY_NOT_EXISTS);
    }
    ...
    public void testDeleteDishesCategory_notExists() {
        ...
        // 调用, 并断言异常
        assertServiceException(() -> dishesCategoryService.deleteDishesCategory(id), DISHES_CATEGORY_NOT_EXISTS);
    }
