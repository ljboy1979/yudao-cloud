...
public class InputsInfoServiceImplTest extends BaseDbUnitTest {
    ...
    public void testUpdateInputsInfo_notExists() {
        ...
        // 调用, 并断言异常
        assertServiceException(() -> inputsInfoService.updateInputsInfo(reqVO), INPUTS_INFO_NOT_EXISTS);
    }
    ...
    public void testDeleteInputsInfo_notExists() {
        ...
        // 调用, 并断言异常
        assertServiceException(() -> inputsInfoService.deleteInputsInfo(id), INPUTS_INFO_NOT_EXISTS);
    }
