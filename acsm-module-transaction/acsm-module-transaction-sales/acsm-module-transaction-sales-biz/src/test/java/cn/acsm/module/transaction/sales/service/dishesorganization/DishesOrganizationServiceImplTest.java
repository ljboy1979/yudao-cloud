...
import cn.acsm.module.transaction.sales.controller.admin.dishesorganization.vo.DishesOrganizationCreateReqVO;
import cn.acsm.module.transaction.sales.controller.admin.dishesorganization.vo.DishesOrganizationExportReqVO;
import cn.acsm.module.transaction.sales.controller.admin.dishesorganization.vo.DishesOrganizationPageReqVO;
import cn.acsm.module.transaction.sales.controller.admin.dishesorganization.vo.DishesOrganizationUpdateReqVO;
...
public class DishesOrganizationServiceImplTest extends BaseDbUnitTest {
    ...
    public void testUpdateDishesOrganization_notExists() {
        ...
        // 调用, 并断言异常
        assertServiceException(() -> dishesOrganizationService.updateDishesOrganization(reqVO), ErrorCodeConstants.DISHES_ORGANIZATION_NOT_EXISTS);
    }
    ...
    public void testDeleteDishesOrganization_notExists() {
        ...
        // 调用, 并断言异常
        assertServiceException(() -> dishesOrganizationService.deleteDishesOrganization(id), ErrorCodeConstants.DISHES_ORGANIZATION_NOT_EXISTS);
    }
