...
public class CommodityOrganizationServiceImplTest extends BaseDbUnitTest {
    ...
    public void testUpdateCommodityOrganization_notExists() {
        ...
        // 调用, 并断言异常
        assertServiceException(() -> commodityOrganizationService.updateCommodityOrganization(reqVO), ErrorCodeConstants.COMMODITY_ORGANIZATION_NOT_EXISTS);
    }
    ...
    public void testDeleteCommodityOrganization_notExists() {
        ...
        // 调用, 并断言异常
        assertServiceException(() -> commodityOrganizationService.deleteCommodityOrganization(id), ErrorCodeConstants.COMMODITY_ORGANIZATION_NOT_EXISTS);
    }
