...
public class RawMaterialSpecificationServiceImplTest extends BaseDbUnitTest {
    ...
    public void testUpdateRawMaterialSpecification_notExists() {
        ...
        // 调用, 并断言异常
        assertServiceException(() -> rawMaterialSpecificationService.updateRawMaterialSpecification(reqVO), ErrorCodeConstants.RAW_MATERIAL_SPECIFICATION_NOT_EXISTS);
    }
    ...
    public void testDeleteRawMaterialSpecification_notExists() {
        ...
        // 调用, 并断言异常
        assertServiceException(() -> rawMaterialSpecificationService.deleteRawMaterialSpecification(id), ErrorCodeConstants.RAW_MATERIAL_SPECIFICATION_NOT_EXISTS);
    }
