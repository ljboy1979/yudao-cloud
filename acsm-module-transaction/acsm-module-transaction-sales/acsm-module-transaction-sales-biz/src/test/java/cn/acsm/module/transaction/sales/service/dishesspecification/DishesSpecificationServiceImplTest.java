...
public class DishesSpecificationServiceImplTest extends BaseDbUnitTest {
    ...
    public void testUpdateDishesSpecification_notExists() {
        ...
        // 调用, 并断言异常
        assertServiceException(() -> dishesSpecificationService.updateDishesSpecification(reqVO), ErrorCodeConstants.DISHES_SPECIFICATION_NOT_EXISTS);
    }
    ...
    public void testDeleteDishesSpecification_notExists() {
        ...
        // 调用, 并断言异常
        assertServiceException(() -> dishesSpecificationService.deleteDishesSpecification(id), ErrorCodeConstants.DISHES_SPECIFICATION_NOT_EXISTS);
    }
