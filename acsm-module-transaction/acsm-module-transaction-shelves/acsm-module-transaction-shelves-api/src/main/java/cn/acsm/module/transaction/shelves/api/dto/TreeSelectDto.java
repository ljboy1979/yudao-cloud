 ...
 * @author ruoyi
 */
public class TreeSelectDto<T> implements Serializable
{
    ...
    public <T extends TreeEntity<T>> TreeSelectDto(T t) {
        this.id = t.getId();
        this.label = t.getName();
        this.children = t.getChildren().stream().map(TreeSelectDto<T>::new).collect(Collectors.toList());
    }
