...
public interface StockClassifyService {
     ...
     * @return 编号
     */
    CommonResult createStockClassify(@Valid StockClassifyCreateReqVO createReqVO);
     ...
     */
    CommonResult updateStockClassify(@Valid StockClassifyUpdateReqVO updateReqVO);
