...
@Slf4j
@Component
public class DemoNoticeDataPermissionRule implements DataPermissionRule {

    /**
     * LoginUser 的 Context 缓存 Key
     */
    protected static final String CONTEXT_KEY = DemoNoticeDataPermissionRule.class.getSimpleName();
     ...
     * value：字段名
     */
    private final Map<String, String> userColumns = new HashMap<>(ImmutableMap.of("system_notice", "creator"));

    /**
     * 所有表名，是 {@link #deptColumns} 和 {@link #userColumns} 的合集
     */
    private final Set<String> TABLE_NAMES = Sets.newHashSet("system_notice");
