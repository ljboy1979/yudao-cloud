...
public class InfoController {
    ...
    @PostMapping("/create")
    @ApiOperation("创建地块信息")
    @PreAuthorize("@ss.hasPermission('tunnel:info:create')")
    ...
    @PutMapping("/update")
    @ApiOperation("更新地块信息")
    @PreAuthorize("@ss.hasPermission('tunnel:info:update')")
    ...
    @PreAuthorize("@ss.hasPermission('tunnel:info:delete')")
    ...
    @PreAuthorize("@ss.hasPermission('tunnel:info:export')")
    ...
    public void exportInfoExcel(@Valid InfoExportReqVO exportReqVO,
        ...
        ExcelUtils.write(response, "地块信息.xls", "数据", InfoExcelVO.class, datas);
    }
