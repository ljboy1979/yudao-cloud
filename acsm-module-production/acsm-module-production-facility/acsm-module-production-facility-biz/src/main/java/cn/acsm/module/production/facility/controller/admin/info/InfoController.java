package cn.acsm.module.production.facility.controller.admin.info;
...
public class InfoController {
    ...
    @PostMapping("/create")
    @ApiOperation("创建设施")
    @PreAuthorize("@ss.hasPermission('facility:info:create')")
    ...
    @PutMapping("/update")
    @ApiOperation("更新设施")
    @PreAuthorize("@ss.hasPermission('facility:info:update')")
    ...
    @PreAuthorize("@ss.hasPermission('facility:info:delete')")
    ...
    @PreAuthorize("@ss.hasPermission('facility:info:query')")
    ...
    @ApiOperation("导出设施 Excel")
    @PreAuthorize("@ss.hasPermission('facility:info:export')")
    ...
    public void exportInfoExcel(@Valid InfoExportReqVO exportReqVO,
        ...
        ExcelUtils.write(response, "设施.xls", "数据", InfoExcelVO.class, datas);
    }
