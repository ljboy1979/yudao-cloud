package cn.acsm.module.production.bases.dal.dataobject.soilenv;
 ...
 * @author 芋道源码
 */
@TableName("bases_soil_env")
@KeySequence("bases_soil_env_seq") // 用于 Oracle、PostgreSQL、Kingbase、DB2、H2 数据库的主键自增。如果是 MySQL 等数据库，可不写。
@Data
...
@NoArgsConstructor
@AllArgsConstructor
public class SoilEnvDO extends BaseDO {
