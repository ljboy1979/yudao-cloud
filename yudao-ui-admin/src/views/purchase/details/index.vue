  ...
  <div class="app-container">
    ...
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="计量单位" prop="unitOfMeasurement">
        <el-input v-model="queryParams.unitOfMeasurement" placeholder="请输入计量单位" clearable @keyup.enter.native="handleQuery"/>
      </el-form-item>
      ...
      <el-form-item label="采购数量/重量" prop="purchaseQuantity">
        <el-input v-model="queryParams.purchaseQuantity" placeholder="请输入采购数量/重量" clearable @keyup.enter.native="handleQuery"/>
      </el-form-item>
      <el-form-item label="期望到货频次" prop="expectedArrivalFrequency">
        <el-input v-model="queryParams.expectedArrivalFrequency" placeholder="请输入期望到货频次" clearable @keyup.enter.native="handleQuery"/>
      </el-form-item>
      <el-form-item label="单价" prop="unitPrice">
        <el-input v-model="queryParams.unitPrice" placeholder="请输入单价" clearable @keyup.enter.native="handleQuery"/>
      </el-form-item>
      <el-form-item label="优惠金额" prop="discountAmount">
        <el-input v-model="queryParams.discountAmount" placeholder="请输入优惠金额" clearable @keyup.enter.native="handleQuery"/>
      </el-form-item>
      <el-form-item label="采购金额" prop="purchaseAmount">
        <el-input v-model="queryParams.purchaseAmount" placeholder="请输入采购金额" clearable @keyup.enter.native="handleQuery"/>
      </el-form-item>
      <el-form-item label="货品id" prop="chargingStandard">
        <el-input v-model="queryParams.chargingStandard" placeholder="请输入货品id" clearable @keyup.enter.native="handleQuery"/>
      </el-form-item>
    ...
    <el-table v-loading="loading" :data="list">
      ...
      <el-table-column label="采购数量/重量" align="center" prop="purchaseQuantity" />
      <el-table-column label="期望到货频次" align="center" prop="expectedArrivalFrequency" />
      ...
      <el-table-column label="货品id" align="center" prop="chargingStandard" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" v-dialogDrag append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="采购数量/重量" prop="purchaseQuantity">
          <el-input v-model="form.purchaseQuantity" placeholder="请输入采购数量/重量" />
        </el-form-item>
        <el-form-item label="期望到货频次" prop="expectedArrivalFrequency">
          <el-input v-model="form.expectedArrivalFrequency" placeholder="请输入期望到货频次" />
        </el-form-item>
        <el-form-item label="单价" prop="unitPrice">
        ...
        <el-form-item label="货品id" prop="chargingStandard">
          <el-input v-model="form.chargingStandard" placeholder="请输入货品id" />
        </el-form-item>
        <el-form-item label="经营主体" prop="subjectId">
  ...
  data() {
    return {
      ...
      queryParams: {
        ...
        expectedArrivalFrequency: null,
        unitPrice: null,
        discountAmount: null,
        purchaseAmount: null,
        chargingStandard: null,
        createTime: [],
        subjectId: null,
      },
      // 表单参数
      ...
      rules: {
        ...
        unitOfMeasurement: [{ required: true, message: "计量单位不能为空", trigger: "blur" }],
        purchaseQuantity: [{ required: true, message: "采购数量/重量不能为空", trigger: "blur" }],
  ...
  methods: {
    ...
    reset() {
      this.form = {
        ...
        expectedArrivalFrequency: undefined,
        unitPrice: undefined,
