      ...
      <el-form-item>
        <el-col :span="10">
          <el-form-item label="法人身份证照片" prop="legalIdCardFrontPhoto">
            ...
            <div style="font-size: 14px;color:#AAA">身份证正面 <span style="font-size: 12px;">仅支持扩展名".jpg/.jpeg/.png"</span>
            </div>
      ...
      <el-form-item>
        <el-col :span="10">
          <el-form-item label="行政区域" prop="name">
            <el-cascader v-model="ruleForm.value" :options="options" @change="handleChange" :props="{ value: 'id' }"
    ...
    return {
      ...
      rules: {
        code: [
          ...
          // { min: 3, max: 5, message: '长度在 3 到 5 符', trigger: 'blur' }
          { min: 1, max: 25, message: '最多输入25', trigger: 'blur' }
        ],
        name: [
          { required: true, message: '请输入主体名称', trigger: 'blur' },
          { min: 1, max: 32, message: '最多输入32', trigger: 'blur' }
        ],
        enterpriseType: [
        ...
        address: [
          ...
          { min: 1, max: 100, message: '最多输入100', trigger: 'blur' }
        ],
        legalPerson: [
        ...
        contactName: [
          ...
          { min: 1, max: 50, message: '最多输入50', trigger: 'blur' }
        ],
        contactPhone: [
        ...
        serviceRange: [
          ...
          { min: 1, max: 120, message: '最多输入120', trigger: 'blur' }
        ],
        description: [
          { required: true, message: '请输入公司简介', trigger: 'blur' },
          { min: 1, max: 3000, message: '最多输入3000', trigger: 'blur' }
        ],
        remarks: [
        ...
        accountName: [
          ...
          { min: 1, max: 64, message: '最多输入64', trigger: 'blur' }
        ],
        accountIdCard: [
