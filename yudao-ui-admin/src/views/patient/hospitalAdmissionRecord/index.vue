  ...
  <div class="app-container">
    ...
    <!-- <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="主治医生" prop="doctor">
        <el-input v-model="queryParams.doctor" placeholder="请输入主治医生" clearable @keyup.enter.native="handleQuery"/>
      </el-form-item>
      <el-form-item label="住院日期" prop="hospitalizationDate">
        <el-date-picker v-model="queryParams.hospitalizationDate" style="width: 240px" value-format="yyyy-MM-dd HH:mm:ss" type="daterange"
      ...
      <el-form-item label="住院类别" prop="hospitalizationCategories">
        <el-input v-model="queryParams.hospitalizationCategories" placeholder="请输入住院类别" clearable @keyup.enter.native="handleQuery"/>
      </el-form-item>
...
<script>
import { createHospitalAdmissionRecord, updateHospitalAdmissionRecord, deleteHospitalAdmissionRecord, getHospitalAdmissionRecord, getHospitalAdmissionRecordPage, exportHospitalAdmissionRecordExcel } from "@/api/patient/hospitalAdmissionRecord";
import Editor from '@/components/Editor';

export default {
  name: "HospitalAdmissionRecord",
  components: {
    Editor,
  },
  props: {
  ...
  data() {
    return {
      ...
      queryParams: {
        ...
        hospitalizationDate: [],
        dischargeDate: [],
        hospitalizationCategories: null,
  ...
  methods: {
    ...
    getList() {
      this.loading = true;
      // 执行查询
      getHospitalAdmissionRecordPage(this.queryParams).then(response => {
    ...
    reset() {
      this.form = {
        ...
        hospitalizationCategories: undefined,
    ...
    handleUpdate(row) {
      this.reset();
      const id = row.id;
      getHospitalAdmissionRecord(id).then(response => {
    ...
    submitForm() {
      this.$refs["form"].validate(valid => {
        ...
        if (this.form.id != null) {
          updateHospitalAdmissionRecord(this.form).then(response => {
        ...
        // 添加的提交
        createHospitalAdmissionRecord(this.form).then(response => {
