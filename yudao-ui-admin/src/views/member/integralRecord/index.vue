  ...
  <div class="app-container">
    ...
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="积分变动时间" prop="integralChangeTime">
        <el-date-picker v-model="queryParams.integralChangeTime" style="width: 240px" value-format="yyyy-MM-dd HH:mm:ss" type="daterange"
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button type="primary" plain icon="el-icon-plus" size="mini" @click="handleAdd"
                   v-hasPermi="['member:integral-record:create']">新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button type="warning" plain icon="el-icon-download" size="mini" @click="handleExport" :loading="exportLoading"
                   v-hasPermi="['member:integral-record:export']">导出</el-button>
      </el-col>
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" v-dialogDrag append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="评分项目" prop="ratingItems">
          <el-input v-model="form.ratingItems" placeholder="请输入评分项目" />
        </el-form-item>
        <el-form-item label="本次积分变动" prop="integralChange">
