...
import cn.acsm.module.user.user.dal.mysql.wechat.WeixinDeployInfoMapper;
...
import static cn.acsm.module.user.user.enums.ErrorCodeConstants.WEIXIN_DEPLOY_INFO_NOT_EXISTS;
