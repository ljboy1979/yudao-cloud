...
import cn.acsm.module.user.user.convert.memberuserinfo.MemberUserInfoConvert;
...
import cn.acsm.module.user.user.dal.mysql.memberuserinfo.MemberUserInfoMapper;
...
import static cn.acsm.module.user.user.enums.ErrorCodeConstants.*;
...
public class MemberUserInfoServiceImpl implements MemberUserInfoService {
     ...
     */
    public CommonResult getOpenIdAndlogin(AppMemberUserInfoRegisteredVO registeredVO){
     ...
     */
    public JSONObject registOrLoginByPhoneAndTenantId(String phone, String tenantId) {
