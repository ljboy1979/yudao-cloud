...
@Slf4j
@Component
public class EnterpriseDataPermissionRule implements DataPermissionRule {

    /**
     * LoginUser 的 Context 缓存 Key
     */
    protected static final String CONTEXT_KEY = EnterpriseDataPermissionRule.class.getSimpleName();
     ...
     * value：字段名
     */
    private final Map<String, String> userColumns = new HashMap<>(ImmutableMap.of("enterprise_base_info", "creator"));

    /**
     * 所有表名，是 {@link #deptColumns} 和 {@link #userColumns} 的合集
     */
    private final Set<String> TABLE_NAMES = Sets.newHashSet("enterprise_base_info");
