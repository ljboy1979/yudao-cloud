...
public class OtherAccountInfoServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetOtherAccountInfoPage() {
        ...
        // 测试 id 不匹配
        otherAccountInfoMapper.insert(cloneIgnoreId(dbOtherAccountInfo, o -> o.setId(null)));
        // 测试 enterpriseId 不匹配
        ...
        // 测试 creator 不匹配
        otherAccountInfoMapper.insert(cloneIgnoreId(dbOtherAccountInfo, o -> o.setCreator(null)));
        // 测试 createTime 不匹配
        otherAccountInfoMapper.insert(cloneIgnoreId(dbOtherAccountInfo, o -> o.setCreateTime(null)));
        // 测试 updater 不匹配
        otherAccountInfoMapper.insert(cloneIgnoreId(dbOtherAccountInfo, o -> o.setUpdater(null)));
        // 测试 updateTime 不匹配
